...
{
    //TODO
    public abstract class GetAndCreate<TEntity, TEntityFilter> : GetService<TEntity, TEntityFilter>, ICreate<TEntity> where TEntity : BaseEntity where TEntityFilter : FilterOptions
    {
