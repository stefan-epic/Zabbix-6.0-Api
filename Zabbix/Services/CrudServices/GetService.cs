...
namespace Zabbix.Services.CrudServices
{
    ...
    public abstract class GetService<TEntity, TEntityInclude, TEntityProperty> : ServiceBase<TEntity, TEntityInclude, TEntityProperty>, IGet<TEntity, TEntityInclude, TEntityProperty>
