...
namespace Zabbix.Entities
{
    ...
    public class ItemPrototype : BaseEntitiy
    {
        ...
        [JsonProperty("preprocessing")] public List<ItemPreprocessing> Preprocessings { get; set; }
        [JsonProperty("valuemap")] public List<ValueMap> ValueMaps { get; set; }
        [JsonProperty("graph_prototype")] public List<GraphPrototype> GraphPrototypes { get; set; } //TODO might be wrong check this
