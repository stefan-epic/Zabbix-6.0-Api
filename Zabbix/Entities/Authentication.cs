...
public class Authentication : BaseEntitiy
{
    ...
    [JsonProperty("authentication_type")] public string AuthenticationType { get; set; }

    [JsonProperty("http_auth_enabled")] public string HttpAuthEnabled { get; set; }

    [JsonProperty("http_login_form")] public string HttpLoginForm { get; set; }

    [JsonProperty("http_strip_domains")] public string HttpStripDomains { get; set; }

    [JsonProperty("http_case_sensitive")] public string HttpCaseSensitive { get; set; }

    [JsonProperty("ldap_configured")] public string LdapConfigured { get; set; }

    [JsonProperty("ldap_host")] public string LdapHost { get; set; }

    [JsonProperty("ldap_port")] public string LdapPort { get; set; }

    [JsonProperty("ldap_base_dn")] public string LdapBaseDn { get; set; }

    [JsonProperty("ldap_search_attribute")]
    public string LdapSearchAttribute { get; set; }

    [JsonProperty("ldap_bind_dn")] public string LdapBindDn { get; set; }

    [JsonProperty("ldap_case_sensitive")] public string LdapCaseSensitive { get; set; }

    [JsonProperty("ldap_bind_password")] public string LdapBindPassword { get; set; }

    [JsonProperty("saml_auth_enabled")] public string SamlAuthEnabled { get; set; }
    ...
    [JsonProperty("saml_sign_messages")] public string SamlSignMessages { get; set; }

    [JsonProperty("saml_sign_assertions")] public string SamlSignAssertions { get; set; }
    ...
    [JsonProperty("saml_encrypt_nameid")] public string SamlEncryptNameid { get; set; }

    [JsonProperty("saml_encrypt_assertions")]
    public string SamlEncryptAssertions { get; set; }

    [JsonProperty("saml_case_sensitive")] public string SamlCaseSensitive { get; set; }

    [JsonProperty("passwd_min_length")] public string PasswdMinLength { get; set; }

    [JsonProperty("passwd_check_rules")] public string PasswdCheckRules { get; set; }
