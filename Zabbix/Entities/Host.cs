...
{
    public class Host : IBaseEntitiy
    {
        #region Properties
        [JsonProperty("hostid")]
        ...
        public IList<Tag> ValueMaps { get; set; }
