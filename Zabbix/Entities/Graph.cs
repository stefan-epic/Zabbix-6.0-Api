...
public class Graph : BaseEntitiy
{
    ...
    [JsonProperty("show_work_period")] public string ShowWorkPeriod { get; set; }

    [JsonProperty("show_triggers")] public string ShowTriggers { get; set; }

    [JsonProperty("graphtype")] public string Graphtype { get; set; }

    [JsonProperty("show_legend")] public string ShowLegend { get; set; }

    [JsonProperty("show_3d")] public string Show3d { get; set; }

    [JsonProperty("percent_left")] public string PercentLeft { get; set; }

    [JsonProperty("percent_right")] public string PercentRight { get; set; }

    [JsonProperty("ymin_type")] public string YminType { get; set; }

    [JsonProperty("ymax_type")] public string YmaxType { get; set; }
