...
public class DashboardPage : BaseEntitiy
{
    ...
    [JsonProperty("widgets")] public List<DashboardWidget> Widgets { get; set; }
}
...
public class Dashboard : BaseEntitiy
{
    ...
    [JsonProperty("auto_start")] public string AutoStart { get; set; }

    [JsonProperty("uuid")] public string Uuid { get; set; }

    [JsonProperty("pages")] public List<DashboardPage> Pages { get; set; }
}
...
public class DashboardWidget : BaseEntitiy
{
    ...
    [JsonProperty("fields")] public List<DashboardField> Fields { get; set; }
}